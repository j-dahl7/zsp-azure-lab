...
def tearDownModule():
    ...
    Every suite in this directory is loaded into a single interpreter, and these
    names can resolve to the real Azure packages when the deployment dependencies
    are installed. Restoring them stops a stub that only this suite wants from
...
_stub_attribute(authorization_module, "AuthorizationManagementClient", object)
...
_stub_attribute(
    authorization_models_module,
    "RoleAssignmentCreateParameters",
    RoleAssignmentCreateParameters,
)

msgraph_module = _stub_module("msgraph")
_stub_attribute(msgraph_module, "GraphServiceClient", object)
...
_stub_attribute(reference_module, "ReferenceCreate", ReferenceCreate)
